...
colnames(temp) <- c("skim_type", "Variable", "Missing",  "complete_rate", "Mean",  "SD",  "numeric.p0", "numeric.p25",  "numeric.p50", "numeric.p75", "numeric.p100", "numeric.hist")
...
```{r}
par(mfrow=c(2,2))
hist(original_tbl$FGA[original_tbl$START_POSITION != ""], breaks = 20, xlim=c(0,40), main="FGA", xlab= "Field Goals Attempted")
hist(rbinom(12300, 50, 0.2), xlim=c(0,40), main="Binom Approx",  xlab= "Samples")
hist(original_tbl$FG_PCT[original_tbl$START_POSITION != ""], breaks = 20, main="FG_pct",  xlab= "Field Goal Percent")
hist(rbeta(12300, 7, 7), xlim=c(0,1), main="Beta Approx",  xlab= "Samples")

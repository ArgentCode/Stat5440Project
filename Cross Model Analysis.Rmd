...
model_1_mean_samps = rbinom(n_iter-burnin, round(mean(N_vec)), p_samples[burnin:n_iter])
model_1_median_samps = rbinom(n_iter-burnin, median(N_vec), p_samples[burnin:n_iter])
model_1_max_samps = rbinom(n_iter-burnin, max(N_vec), p_samples[burnin:n_iter])
```
...
df = data.frame(Mean = model_1_mean_samps,
